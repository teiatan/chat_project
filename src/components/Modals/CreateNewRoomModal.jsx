            ...
            <div className="flex flex-col gap-5 w-3/4">
                ...
                {isPrivate &&
                    <div className='relative'>
                        ...
                        <input type={passwordType} className="w-full px-4 py-2 border rounded" />
                        <BsEyeSlash onClick={togglePassword} className='absolute bottom-8 right-2 cursor-pointer' />
                        <p class="text-sm">*Після створення кімнати ключ змінити не можна</p>
                    </div>
                }
